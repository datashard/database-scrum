...
insert into zutat values (1001,'Zucchini','Stück', 0.89, 100, 101,19,2,1.6, 10);
insert into zutat values (1002,'Zwiebel','Stück', 0.15, 50, 101, 28, 4.9, 1.20, 10);
insert into zutat values (1003, 'Tomate', 'Stück', 0.45, 50, 101, 18, 2.6, 1, 10);
insert into zutat values (1004, 'Schalotte', 'Stück', 0.20, 500, 101, 25, 3.3, 1.5, 10);
insert into zutat values (1005, 'Karotte', 'Stück', 0.30, 500, 101, 41, 10, 0.9, 10);
insert into zutat values (1006, 'Kartoffel', 'Stück', 0.15, 1500, 101, 71, 14.6, 2, 10);
insert into zutat values (1007, 'Rucola', 'Bund', 0.90, 10, 101, 27, 2.1, 2.6, 10);
insert into zutat values (1008, 'Lauch', 'Stück', 1.2, 35, 101, 29, 3.3, 2.1, 10);
insert into zutat values (1009, 'Knoblauch', 'Stück', 0.25, 250, 101, 141, 28.4, 6.1, 10);
insert into zutat values (1010, 'Basilikum', 'Bund', 1.3, 10, 101, 41, 5.1, 3.1, 10);
insert into zutat values (1011, 'Süßkartoffel', 'Stück', 2.0, 200, 101, 86, 20, 1.6, 10);
insert into zutat values (1012, 'Schnittlauch', 'Bund', 0.9, 10, 101, 28, 1, 3, 10);
insert into zutat values (2001, 'Apfel', 'Stück', 1.2, 750, 102, 54, 14.4, 0.3, 10);
insert into zutat values (3001, 'Vollmilch. 3.5%', 'Liter', 1.5, 50, 103, 65, 4.7, 3.4, 10);
